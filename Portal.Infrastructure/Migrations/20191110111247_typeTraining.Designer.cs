...
namespace Portal.Infrastructure.Migrations
{
    ...
    [Migration("20191110111247_typeTraining")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portal.Application.Models.Client", b =>
                {
                    ...
                    b.Property<Guid?>("GroupTrainingTrainingID");

                    b.Property<int>("Sex");

                    b.HasIndex("GroupTrainingTrainingID");
            ...
            modelBuilder.Entity("Portal.Application.Models.GroupTraining", b =>
                {
                    b.HasBaseType("Portal.Application.Models.Training");
            ...
            modelBuilder.Entity("Portal.Application.Models.IndividualTraining", b =>
                {
                    b.HasBaseType("Portal.Application.Models.Training");
            ...
            modelBuilder.Entity("Portal.Application.Models.Client", b =>
                {
                    b.HasOne("Portal.Application.Models.GroupTraining")
                        .WithMany("Participants")
                        .HasForeignKey("GroupTrainingTrainingID");
                });

            modelBuilder.Entity("Portal.Application.Models.IndividualTraining", b =>
                {
                    b.HasOne("Portal.Application.Models.Client", "Participant")
                        .WithMany()
